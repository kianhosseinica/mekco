    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_type', models.CharField(blank=True, choices=[('bronze', 'Bronze'), ('gold', 'Gold'), ('hvac', 'HVAC'), ('individual', 'Individual'), ('platinum', 'Platinum'), ('silver', 'Silver'), ('supplier', 'Supplier')], max_length=50, null=True)),
